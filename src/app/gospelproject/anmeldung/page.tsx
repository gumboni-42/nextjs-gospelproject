                    ...
                    <div className="rounded-2xl p-8 sm:p-12" style={{ backgroundColor: 'var(--surface)' }}>
                        ...
                        {data.signupLimit && data.signupCount >= data.signupLimit ? (
                            <div className="text-center p-12 rounded-2xl border my-8" style={{ backgroundColor: 'var(--surface)', borderColor: 'var(--border-color)' }}>
                                ...
                                <h3 className="text-2xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>Ausgebucht</h3>
                                <p className="text-lg" style={{ color: 'var(--text-muted)' }}>Leider sind für dieses Projekt bereits alle Plätze belegt. Wir freuen uns, wenn du beim nächsten Mal dabei bist!</p>
                            </div>
                        ) : (
                            <>
                                <p className="text-center mb-8 max-w-xl mx-auto" style={{ color: 'var(--text-muted)' }}>Fülle das Formular aus, um dich für das nächste Gospelproject anzumelden.</p>
                                <SignupForm />
                            </>
                        )}
                    </div>
